...
public class ContractClass {
    public static final String AUTHORITY = "com.example.user.freshnews.data.provider.ContractClass";
    ...
    public static final class News implements BaseColumns {
        ...
        private static final String PATH_NEWS_SERVER = "/news/server";
        ...
        public static final Uri CONTENT_URI_SERVER = Uri.parse(SCHEME + AUTHORITY + PATH_NEWS_SERVER);
